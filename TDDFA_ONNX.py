...
def _build_session_options():
    ...
    thread_count = max(1, int(os.getenv('INFERENCE_THREADS_PER_WORKER', '1')))
...
class TDDFA_ONNX(object):
    ...
    def __init__(self, **kvs):
        ...
        self.bfm_session = onnxruntime.InferenceSession(bfm_onnx_fp, _build_session_options())
        ...
        self.session = onnxruntime.InferenceSession(onnx_fp, _build_session_options())
